...
class StatusAPI(BaseAdministrationAPI):
    API_ROOT = "https://{0}.cybozu.com/k/v1{1}/app/status.json"

    def __init__(self, account, api_token="", requests_options=(), app_id=""):
        super(StatusAPI, self).__init__(account, api_token, requests_options, app_id)
